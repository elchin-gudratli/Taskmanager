...
<!-- Mirrored from www.wrraptheme.com/templates/lucid/hr/html/light/client-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Oct 2019 13:48:24 GMT -->
<head>
<title>:: Lucid HR :: Clients Detail</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="client-detail.html">Clients Detail</a></li>
                                </ul>
                            </li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Client Detail</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card client-detail">                    
                        <div class="body">
                            ...
                            <div class="details">
                                <h4 class="m-t-0 m-b-0"><strong>${user.name}</strong> ${user.surname}</h4>
