...
<!-- Mirrored from www.wrraptheme.com/templates/lucid/hr/html/light/project-team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Oct 2019 13:48:24 GMT -->
<head>
<title>:: Lucid HR :: Team</title>
<meta charset="utf-8">
                ...
                <div class="tab-pane animated fadeIn active" id="project_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="/teams"><i class="icon-users"></i>Team</a></li>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12">
                    <div class="float-right mt-3">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-option1-tab" data-toggle="pill" href="#pills-option1" role="tab"
                                    aria-controls="pills-option1" aria-selected="true">Option 1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-option2-tab" data-toggle="pill" href="#pills-option2" role="tab"
                                    aria-controls="pills-option2" aria-selected="false">Option 2</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                <div class="tab-content" id="option-tabContent">
                    <div class="tab-pane fade show active" id="pills-option1" role="tabpanel" aria-labelledby="pills-option1-tab">
                        <div class="row">
                         <c:forEach items="${liste}" var="team">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="header">
                                        <h2>Web Designing Team</h2>
                                    </div>
                                    <div class="body text-center">
                                        <div class="team-lead">
                                            <img class="rounded-circle img-thumbnail mx-auto d-block mb-2" src="/assets/images/sm/avatar1.jpg"
                                                alt="">
                                            <h6 class="project-title text-primary mb-2 font-15">${team.name}</h6>
                                        ...
                                        <div class="align-items-center d-flex justify-content-center">
                                            <h6 class="mb-0 mr-2">Employees:</h6>
                                            <ul class="list-unstyled team-info margin-0">
                                                ...
                                                <li><img src="/assets/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title=""
                                                        alt="Avatar" data-original-title="Joge Lucky"></li>
                                                <li><img src="/assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title=""
                                                        alt="Avatar" data-original-title="Folisise Chosielie"></li>
                                                <li><img src="/assets/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title=""
                                                        alt="Avatar" data-original-title="Joge Lucky"></li>
                                            </ul>
                                        </div>
