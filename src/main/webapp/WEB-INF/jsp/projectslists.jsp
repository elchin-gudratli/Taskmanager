...
<!-- Mirrored from www.wrraptheme.com/templates/lucid/hr/html/light/project-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Oct 2019 13:48:05 GMT -->
<head>
<title>:: Lucid HR :: Projects List</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="project-list.html">Projects List</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                    <c:forEach items="${liste}" var="project">
